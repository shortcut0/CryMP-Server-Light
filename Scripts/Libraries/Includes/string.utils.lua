...
ToString = function(...)
	local s = nil
	for _,ss in pairs({...}) do
		s = (s or "")..(s~=nil and", "or"")..tostring(ss)
	end
	return (s==nil and"<Null>"or s)
end
ToNumber = tonumber
...
string.getalphabet = function() return "abcdefghijklmnopqrstuvwxyz" end
...
string.bool = function(bOk, sYes, sNo)
	...
	---------
	sYes = CheckVar(sYes, "true")
	sNo = CheckVar(sNo, "false")

	---------
	return (bOk and sYes or sNo)
end
