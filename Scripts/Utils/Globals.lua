...
CommandArg_TypePlayerOrString = 4.1   -- Expects a valid player, if non found, passes literal string instead
...
CommandArg_TypeAccessSame = 7.1   -- a valid server access level (equal as the user)
CommandArg_TypeAccessEqual = 7.2   -- a valid server access level (equal or lower than the user)
CommandArg_TypeAccessLower = 7.3   -- a valid server access level (lower than the users)
CommandArg_TypeAccessHigher = 7.4   -- a valid server access level (higher than the users)
